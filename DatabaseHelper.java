...
public class DatabaseHelper {
    // Đã fix serverTimezone=Asia/Ho_Chi_Minh để giờ nhắn tin chuẩn xác
    private static final String URL = "jdbc:mysql://localhost:3306/quanlyluong?useSSL=false&serverTimezone=Asia/Ho_Chi_Minh&allowPublicKeyRetrieval=true";
    ...
    public static void initDatabase() {
        try (Connection conn = getConnection(); Statement stmt = conn.createStatement()) {
            ...
            // Bảng quản lý Quỹ nghỉ phép
            stmt.execute("CREATE TABLE IF NOT EXISTS leave_balances (employee_id VARCHAR(50) PRIMARY KEY, remaining_days INT DEFAULT 12)");

            System.out.println("✅ Khởi tạo CSDL thành công!");
