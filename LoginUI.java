...
public class LoginUI extends JFrame {
    ...
    private JPanel createLoginCard() {
        ...
        btnShowPass.addActionListener(e -> {
            if (txtPass.getEchoChar() == (char) 0) {
                ...
                btnShowPass.setForeground(COLOR_LOGIN);
            }
        });
    ...
    private void showForgotPasswordDialog() {
        ...
        if (JOptionPane.showConfirmDialog(this, message, "Khôi phục mật khẩu", JOptionPane.OK_CANCEL_OPTION,
            ...
            if (EmployeeManager.getInstance().resetPassword(user, email, newPass)) {
                ...
                JOptionPane.showMessageDialog(this, "❌ Sai tên tài khoản hoặc Email không khớp!", "Lỗi",
    ...
    private JPanel createRegisterCard() {
        ...
        lblRole.setBounds(60, y, 300, 20);
        y += 20;
        JComboBox<String> cbRole = new JComboBox<>(
                new String[] { "Người Quản Lý (Tạo công ty)", "Nhân Viên (Xin việc)" });
        cbRole.setBounds(60, y, 300, 35);
        ...
        lblUser.setForeground(TEXT_SECONDARY);
        lblUser.setFont(new Font("Tahoma", Font.BOLD, 12));
        lblUser.setBounds(60, y, 300, 20);
        y += 20;
        RoundedTextField txtUser = new RoundedTextField();
        txtUser.setBounds(60, y, 300, 35);
        txtUser.setBackground(Color.WHITE);
        y += 40;

        JLabel lblFullName = new JLabel("Họ và Tên:"); // ĐÃ MỞ CHO CẢ SẾP
        lblFullName.setForeground(TEXT_SECONDARY);
        lblFullName.setFont(new Font("Tahoma", Font.BOLD, 12));
        lblFullName.setBounds(60, y, 300, 20);
        y += 20;
        RoundedTextField txtFullName = new RoundedTextField();
        txtFullName.setBounds(60, y, 300, 35);
        ...
        lblEmail.setBounds(60, y, 300, 20);
        y += 20;
        RoundedTextField txtEmail = new RoundedTextField();
        txtEmail.setBounds(60, y, 300, 35);
        ...
        lblPhone.setBounds(60, y, 300, 20);
        y += 20;
        RoundedTextField txtPhone = new RoundedTextField();
        txtPhone.setBounds(60, y, 300, 35);
        ...
        lblCode.setBounds(60, y, 300, 20);
        y += 20;
        RoundedTextField txtCode = new RoundedTextField();
        txtCode.setBounds(60, y, 300, 35);
        ...
        lblPass.setForeground(TEXT_SECONDARY);
        lblPass.setFont(new Font("Tahoma", Font.BOLD, 12));
        lblPass.setBounds(60, y, 300, 20);
        y += 20;
        RoundedPasswordField txtPass = new RoundedPasswordField();
        txtPass.setBounds(60, y, 300, 35);
        txtPass.setBackground(Color.WHITE);
        y += 40;

        JLabel lblConfirmPass = new JLabel("Xác nhận mật khẩu:");
        lblConfirmPass.setForeground(TEXT_SECONDARY);
        lblConfirmPass.setFont(new Font("Tahoma", Font.BOLD, 12));
        lblConfirmPass.setBounds(60, y, 300, 20);
        y += 20;
        RoundedPasswordField txtConfirmPass = new RoundedPasswordField();
        txtConfirmPass.setBounds(60, y, 300, 35);
        ...
        btnRegister.setBounds(60, y, 300, 45);
        y += 60;
        btnRegister.setBackground(COLOR_REGISTER);
        ...
        lblSwitch.setFont(new Font("Tahoma", Font.PLAIN, 13));
        lblSwitch.setForeground(COLOR_LOGIN);
        lblSwitch.setCursor(new Cursor(Cursor.HAND_CURSOR));
        lblSwitch.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
        ...
        btnRegister.addActionListener(e -> {
            ...
            if (u.isEmpty() || name.isEmpty() || email.isEmpty() || phone.isEmpty() || p.isEmpty()
                    || confirmP.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Vui lòng điền đầy đủ tất cả các trường!");
                return;
            }
            ...
            if (role.equals("ADMIN")) {
                ...
                if (code.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Nhân viên bắt buộc phải điền Mã công ty giới thiệu!");
                    return;
                }
